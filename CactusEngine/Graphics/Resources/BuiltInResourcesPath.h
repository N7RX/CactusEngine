...
namespace Engine
{
	namespace BuiltInResourcesPath
	{
		...
		static const char* SHADER_FRAGMENT_GAUSSIANBLUR = "Assets/Shader/GLSL/Gaussian.frag";
		static const char* SHADER_FRAGMENT_DEPTH_COLORBLEND_2 = "Assets/Shader/GLSL/DepthBased_ColorBlend_2.frag";
		static const char* SHADER_FRAGMENT_LINEDRAWING_CURVATURE = "Assets/Shader/GLSL/LineDrawing_Curvature.frag";
		static const char* SHADER_FRAGMENT_LINEDRAWING_COLOR = "Assets/Shader/GLSL/LineDrawing_Color.frag";
		static const char* SHADER_FRAGMENT_LINEDRAWING_BLEND = "Assets/Shader/GLSL/LineDrawing_Blend.frag";
